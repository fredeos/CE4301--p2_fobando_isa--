module tb_hazard_unit;
    ...
    initial begin
        ...
        check_outputs(1'b1, 1'b0, 1'b1, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0,
                      SRC_PIPE, SRC_ALU, SRC_PIPE,
                      32'h1111_1111, 32'hAAAA_AAAA, 32'h3333_3333,
                      "store_en_ex_espera_si_productor_esta_en_mem");
        ...
        clear_inputs();
        EXInstr  = enc_normal(OP_M_ST, '0, 5'd6, 5'd0, 5'd0);
        MEMInstr = enc_normal(OP_R, ALU_ADD, 5'd6, 5'd1, 5'd2);
        #1;
        check_outputs(1'b1, 1'b0, 1'b1, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0,
                      SRC_PIPE, SRC_ALU, SRC_PIPE,
                      32'h1111_1111, 32'hAAAA_AAAA, 32'h3333_3333,
                      "store_en_ex_espera_a_wb_para_dato");
        ...
        clear_inputs();
        EXInstr  = enc_secure(OP_V_ST, '0, 3'd2, 3'd0, 3'd0, 3'd0);
        MEMInstr = enc_secure(OP_PI, ALU_ADD, 3'd2, 3'd1, 3'd0, 3'd0);
        #1;
        check_outputs(1'b1, 1'b0, 1'b1, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0,
                      SRC_ALU, SRC_PIPE, SRC_PIPE,
                      32'hAAAA_AAAA, 32'h2222_2222, 32'h3333_3333,
                      "vault_store_en_ex_espera_a_wb_para_dato");
        ...
        clear_inputs();
        EXInstr  = enc_normal(OP_R, ALU_SUB, 5'd9, 5'd8, 5'd7);
        MEMInstr = enc_normal(OP_M_LD, '0, 5'd5, 5'd1, 5'd0);
        IDInstr  = enc_normal(OP_R, ALU_ADD, 5'd7, 5'd5, 5'd6);
        #1;
        check_outputs(1'b1, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0,
